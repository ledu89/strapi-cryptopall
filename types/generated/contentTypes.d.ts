...
export interface ApiCryptoAssetCryptoAsset extends Schema.CollectionType {
  ...
  attributes: {
    ...
    market_cap_rank: Attribute.Integer;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    crypto_assets: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::crypto-asset.crypto-asset'
    >;
    deposit: Attribute.Decimal & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
